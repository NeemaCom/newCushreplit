...
import { Bell, Menu, ChevronDown, Home } from "lucide-react";
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6 space-x-4">
              ...
              <Button 
                variant="ghost" 
                size="sm" 
                className="p-3 hover:bg-cush-primary-50 hover:text-cush-primary rounded-xl transition-all duration-200"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white">
              <a href="/" className="flex items-center px-3 py-2 text-blue-600 font-medium">
              ...
              <a href="/imisi" className="block px-3 py-2 text-gray-500">
                AI Assistant
              </a>
